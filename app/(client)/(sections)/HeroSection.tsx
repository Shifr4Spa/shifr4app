...
import NavbarAgrod from "@/app/components/NavbarAgrod";
        ...
        <div className="relative z-10 min-h-screen">
          <div className="absolute mx-auto flex min-h-full w-full items-center justify-between px-4 py-2 text-center">
            <div className="container m-auto space-y-7">
              ...
              {/* Animated Button */}
              <motion.button
                className="ring-offset-background focus-visible:ring-ring hover:bg-primary/90 inline-flex h-10 items-center justify-center bg-[#971e24] px-5 py-7 text-sm font-medium uppercase text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-r-0"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
