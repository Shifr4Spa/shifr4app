...
function Service() {
  return (
    <div className="min-h-screen !bg-[#121212]">
      ...
      <div className="bg-[#efefef] flex flex-col items-center text-black pt-[4rem] pb-[5rem]">
            ...
            <div className="fontRoboto grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-8">
              {whyChooseServices.map((chooseService, idx) => (
                <div key={idx} className="flex flex-col">
                  ...
                  <h3 className="fontFrank mb-2 text-xl font-normal sm:mb-4 sm:text-2xl">
                    {chooseService.title}
                  </h3>
          ...
          <div className="mx-auto mt-10 max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="mx-auto px-0 py-8 sm:px-0 sm:py-12 lg:px-0 lg:py-16">
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                <div className="relative h-[300px] overflow-hidden rounded-lg sm:h-200 lg:order-last lg:h-full">
                  <Image
                    width={100}
                    height={100}
                    alt="Party"
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
              <div className="max-w-xl sm:text-center md:mx-auto">
                ...
                <p className="fontRoboto mt-3 font-thin">
                  Descubre las experiencias de aquellos que confiaron en
                  nuestros servicios legales. Sus testimonios reflejan nuestro
