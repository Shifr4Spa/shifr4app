...
import { teamLawyers } from "@/app/utils/globals";
            ...
            <ul className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              {teamLawyers.map((lawyer, idx) => (
                <li key={idx}>
                  ...
                  <div className="mt-4">
                    <h4 className="fontFrank text-3xl font-normal">
                      {lawyer.name}
                    </h4>
                    <p className="text-[#981e25]">{lawyer.title}</p>
                    <p className="text-gray-600 mt-5">{lawyer.desc}</p>
